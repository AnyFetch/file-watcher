...
var getDeletedFiles = function(filesOnDisk) {
  var filesToDelete = [];
  Object.keys(GLOBAL.CURSOR).forEach(function(file) {
    if(filesOnDisk[file] === undefined) {
...
module.exports.retrieveFiles = function retrieveFiles(cb) {
  ...
  getCursorFromDirectory(function(err, filesOnDisk) {
    ...
    var filesToDelete = getDeletedFiles(filesOnDisk);
